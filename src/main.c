...
/*
        ...
        # all lines start with a command symbol, '#' is for comments and is
   ignored
        # any unknown symbol (example: whitespace) also results in an ignored
   line
